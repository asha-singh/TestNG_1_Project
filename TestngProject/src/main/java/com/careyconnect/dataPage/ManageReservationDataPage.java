...
public class ManageReservationDataPage {
	     ...
	     private boolean isDateTimeChange; 
	     private boolean isPULocationChange;
	     private boolean isDOLocationChange;
	     private boolean isTripTypeChange;
	     private boolean isVehicleTypeChange;
	     private boolean isTimePeriodChange;
	     private boolean isPaymentTypeChange;
	     ...
	     private Boolean IsAirportDropoffValidate;
		...
		private String Card_CVV;
	     ...
	     public String getDescription() {
			...
			public void setExecuted(String isExecuted) {
			 ...
			 public boolean isExisting() {
				...
				public Boolean getIsAirportDropoffValidate() {
					return IsAirportDropoffValidate;
				}
				public void setIsAirportDropoffValidate(Boolean isAirportDropoffValidate) {
				...
				public boolean isDateTimeChange() {
					return isDateTimeChange;
				}
				public void setDateTimeChange(boolean isDateTimeChange) {
					this.isDateTimeChange = isDateTimeChange;
				}
				...
				public boolean isPULocationChange() {
					return isPULocationChange;
				}
				public void setPULocationChange(boolean isPULocationChange) {
					this.isPULocationChange = isPULocationChange;
				}
				public boolean isDOLocationChange() {
					return isDOLocationChange;
				}
				public void setDOLocationChange(boolean isDOLocationChange) {
					this.isDOLocationChange = isDOLocationChange;
				}
				public boolean isTripTypeChange() {
					return isTripTypeChange;
				}
				public void setTripTypeChange(boolean isTripTypeChange) {
					this.isTripTypeChange = isTripTypeChange;
				}
				public boolean isVehicleTypeChange() {
					return isVehicleTypeChange;
				}
				public void setVehicleTypeChange(boolean isVehicleTypeChange) {
					this.isVehicleTypeChange = isVehicleTypeChange;
				}
				public boolean isTimePeriodChange() {
					return isTimePeriodChange;
				}
				public void setTimePeriodChange(boolean isTimePeriodChange) {
					this.isTimePeriodChange = isTimePeriodChange;
				}
				public boolean isPaymentTypeChange() {
					return isPaymentTypeChange;
				}
				public void setPaymentTypeChange(boolean isPaymentTypeChange) {
					this.isPaymentTypeChange = isPaymentTypeChange;
				}
}
